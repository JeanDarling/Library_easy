...
<body background="../img/background.jpg">
	<h2 align="center" style="margin-top: 20px;">图书馆管理系统|管理员界面</h2>
	<div class="container">
			...
			<div class=" col-md-9 carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img class="imgs" src="../img/timg3.jpg">
					</div>
					<div class="carousel-item">
						<img class="imgs" src="../img/timg1.jpg">
					</div>
					<div class="carousel-item">
						<img class="imgs" src="../img/timg2.jpg">
					</div>
				</div>
