			...
			<div align="center" class="col-md-3">
				<ul class="list-group">
					...
					<li class="list-group-item    "><a href="../FenYe"><span
							style="color: black">学生信息</span></a></li>
					...
					<li class="list-group-item"><a href="admin_register.jsp"><span
							style="color: black">添加管理</span></a></li>
							...
							<tr>
								...
								<td><select style="margin-left: 50px; margin-top: 10px;"
									class="form-control inputclass" name="press">
										<option>机械工程出版社</option>
										<option>同济大学出版社</option>
										<option>人民日报出版社</option>
										<option>电子工业出版社</option>
										<option>国家开发大学出版社</option>
										<option>浙江大学出版社</option>
										<option>私人教育出版社</option>
										<option>华东理工大学出版社</option>
										<option>山东大学出版社</option>
										<option>北京理工大学出版社</option>
